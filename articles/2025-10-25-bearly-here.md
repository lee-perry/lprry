...
I have been thinking about doing something different with my web presence for some time.  I have built a fantastic Kirby CMS based website over at [lee-perry.co.uk](https://lee-perry.co.uk).  For some reason though I find it frictious to work with, largely ceasing to post anything of consequence, mainly cataloguing image and micro posts within my digital garden.  I've posted on that domain for over 20 years though, so its not going anywhere, not yet at least.

I first started experimenting with [Bear](https://bearblog.dev) a couple months ago, with a new domain that I picked up [l33.co.uk](https://l33.co.uk). I promptly set about starting to rebuild something that replicated everything that my main website did, and of course that's not what Bear does.  I still find it weird that microformats are not baked in - but I think baking microformats into my post templates removed from the minimalist aesthetic of the writing experience.  Wrapping a stack of HTML around every post is just ugly.
...
So the Bear idea gnawed at me over the summer, and I revisited it after moving my personal mastodon hosting to self hosted server at yet another new domain that I love, [prry.uk](https://prry.uk/@lee), and which I have also moved my personal email to with Proton, as I begin to see signs of Apple collaborating with bad people.  Eventually I dived in and picked up a lifetime subscription, which I was wary about given that it is not the first lifetime subscription that I hold to a blogging platform that I hold.
...
So far I have set up Bear to have discreet [blog](article), [note](/notes) (micropost) and [snap](/snaps) (imagepost) sections, as well as dedicated sections for [training](/training-log) and [weigh-in](weigh-ins) data which are powered only by the post title at this point.  Strangely I seen to find the posting process less frictious, even though I am entering essentially the same information.
...
![Screenshot of the homepage of this website in dark made, with black and orange colors reminiscent of the Burnley third strip in season 2025-6](/assets/images/07.webp)
...
I still have some work to do, but the main item on my list is to implement webmention send and receive, where I will be using the instructions provided and linked to by [gobino](https://gobino.be/adding-webmentions-to-my-blog-tutorial/).  If I can get that running and displaying anywhere near as well as it does on their blog, I'll probably hang out here for a while.  
